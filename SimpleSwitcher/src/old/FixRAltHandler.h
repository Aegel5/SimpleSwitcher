...
//			&& conf_get_unsafe()->fixRAlt
//			&& conf_get_unsafe()->fixRAlt_lay_ != 0
//			) {
//
//			auto info = Utils::GetFocusedWndInfo();
//			auto need_lay = conf_get_unsafe()->fixRAlt_lay_;
...
//
//			if (conf_get_unsafe()->layouts_info.GetLayoutInfo(need_lay) == nullptr) {
//				if (temp_lay == 0) {
