...
Есть вопрос, предложение или найден баг - добро пожаловать в [Issues](https://github.com/Aegel5/SimpleSwitcher/issues). Issues c тегом `discussion` служат для обсуждения.
