...
Есть вопрос, предложение или найден баг - добро пожаловать в [Issues](https://github.com/Aegel5/SimpleSwitcher/issues). Issues c тегом `discussion` служат для обсуждения. **Важно:** если проблема уже есть в списке, то лучше оставить все равно комментарий, чтобы показать, что проблема актуальна.
