...
Simple Switcher - программа для быстрого исправления раскладки набранного текста в Windows. Написан на современном С++ 23 (по большей части 🤦‍♂️), турбо-реактивен и никак не сказывается на работе ОС. Список фич небольшой, но при этом каждая фича прорабатывается, чтобы быть надежной и понятной.
