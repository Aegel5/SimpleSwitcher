...
> [!IMPORTANT]
> **Все новые версии (начиная с 6.10.*) собираются на серверах GitHub.**
> Поэтому нет необходимости собирать программу из исходного кода самостоятельно в целях безопасности — облачная сборка гарантирует чистоту бинарных файлов.
