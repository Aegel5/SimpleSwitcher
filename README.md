...
- Возможность использовать практически любые сочитания клавиши, например, Capslock, Scrolllock, RAlt, Ctrl #up, LWin + ... для любой функции программы.
...
Настройка пока только через `SimpleSwitcher.json`
