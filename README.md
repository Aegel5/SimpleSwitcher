...
ℹ️ **Все новые версии (начиная с 6.10.2) собираются на серверах GitHub как _Immutable_ релизы.** ℹ️ Поэтому нет необходимости собирать программу из исходного кода самостоятельно в целях безопасности — облачная сборка гарантирует чистоту бинарных файлов.
...
Самый универсальный. Назначить оба хоткея на требуемые функции. Переключение будет работать как в случае если CapsLock был переназначен, так и не был.
