...
_Рекомендуется:_ использование клавиши CapsLock как хот-кей без переназначения (бета-функционал).
...
2204 3201 3246 4951 - карта МИР, можно через СБП (пишите сообщение от кого, я добавлю всех поддержавших сюда).
